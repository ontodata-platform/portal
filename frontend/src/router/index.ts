    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { titleKey: 'menu.search', group: 'groupCollab' },
        },
        {
          path: 'marketplace',
        ...
        },
        {
          ...
          meta: { titleKey: 'menu.requirements', group: 'groupCollab' },
        },
        {
          path: 'scenarios',
          component: () => import('@/views/ScenariosView.vue'),
          meta: { titleKey: 'menu.scenarios', group: 'groupCollab' },
        },
        {
          path: 'agent/chat',
          component: () => import('@/views/AgentChatView.vue'),
          meta: { titleKey: 'menu.agentChat', group: 'groupCollab' },
        },
        {
          path: 'operations',
