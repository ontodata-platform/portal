...
export const seedNotifications: SeedNotification[] = [
  ...
  { id: 'ntf-004', type: 'APPROVAL_OVERDUE', title: 'SAR 申请已超期', body: 'SAR 影像订阅申请已超过办理时限，请尽快处理。', resourceRef: 'apr-overdue-003', createdHoursAgo: 5 },
  { id: 'ntf-005', type: 'RESULT_READY', title: '目标特性报告可领取', body: '质量分析报告-2026W37 已生成，可在结果签页下载。', resourceRef: 'result-quality-002', createdHoursAgo: 14 },
...
export function createSeedApprovals(): RecordValue[] {
  return [
    ...
    { code: 'apr-r4-sample', approvalType: 'R4_TOOL_CALL', sourceSystem: 'mcp-gateway', sourceCode: 'cfm-sample', title: '航线规划工具服务开通申请', requester: '陈晓', status: 'PENDING', slaStatus: 'ON_TIME', detail: { tool: 'workflow.submit_execution', riskLevel: 'R4' }, createdAt: stamp(4), updatedAt: stamp(3) },
    ...
    { code: 'apr-overdue-003', approvalType: 'DATA_GRANT', sourceSystem: 'data-platform', sourceCode: 'ds-sar-maritime', title: 'SAR 影像订阅申请（超期催办示例）', requester: '王工', status: 'PENDING', slaStatus: 'OVERDUE', slaDeadline: stamp(30), detail: { serviceCode: 'ds-sar-maritime' }, createdAt: stamp(48), updatedAt: stamp(6) },
    { code: 'apr-due-004', approvalType: 'R4_TOOL_CALL', sourceSystem: 'mcp-gateway', sourceCode: 'cfm-due-soon', title: '测高波形数据使用申请（今日到期待办）', requester: 'alice', status: 'PENDING', slaStatus: 'DUE_SOON', slaDeadline: relativeIso(-4), detail: { tool: 'dataset.export', riskLevel: 'R4' }, createdAt: stamp(20), updatedAt: stamp(2) },
